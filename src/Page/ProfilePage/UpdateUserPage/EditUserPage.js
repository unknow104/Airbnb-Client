...
export default function EditUserPage() {
  ...
  return (
    <div className="mt-24 mx-auto">
      <div className='mx-auto flex w-max mb-10'>
        <h1 className=" uppercase font-bold text-primary text-[20px] text-center mx-[300px] flex ">
      ...
      <div className="">
        <Form form={form} onFinish={onFinish} initialValues={{ gender: 'gender', image: [imageUrl] }}>
          <Form.Item
            label="Ảnh của bạn"
            name="image"
            labelCol={labelCol}
          ...
          >
            <Upload
              ...
              beforeUpload={() => false}
              fileList={imageChange.originFileObj ? [imageChange.originFileObj] : []}
